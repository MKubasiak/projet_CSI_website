...
END;
            $all = $db->getAllParticipations();
            foreach($all as $one) {
                $user = $db->getUser($one['idutilisateur']);
                $event = $db->getEvent($one['idevenement']);
                echo '
                        <div class="row">
                            <div class="carousel-inner">
                                <div class="col-sm-4">
                                    <div class="single-event">
                                        <h4>' . $user['nom'] . ' ' . $user['prenom'] . ' participe à l\'événement : '. $event['titreevenement'] .'<br/>qui se déroulera <br/>du ' . $event['datedebut'] . '<br/>au ' . $event['datefin'] . '</h4>
                                    </div>
                                </div>
                            </div>
                        </div>';
